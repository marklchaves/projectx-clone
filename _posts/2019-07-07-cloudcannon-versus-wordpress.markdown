...
**P.s.** This review was 100% written in *markdown* using the *Visual Studio Code* editor and originally pubslished on my prorotype CloudCannon site. No worrying about slow loading, feature heavy, and clunky *Gutenberg* site builders. With Jekyll and CloudCannon, gone are the days of having a minimum of three page builders installed just for one site:  Freedom at last!
